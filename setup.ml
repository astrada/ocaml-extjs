...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0f7027ee9a38884bc5e8b809c30769e0) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Ext JS 4.2 bindings for the js_of_ocaml compiler";
          description = None;
          categories = [];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title =
                        "API reference for Ext JS 4.2 client library";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\194\196\\zt\141\172eDr$z)\151\248/";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
