...
(* OASIS_START *)
(* DO NOT EDIT (digest: ccde4ba8cfcfa29f36c7acd0a7c57ff7) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("oextjs", OCamlbuildDocPlugin.doc_build "lib/")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("oextjs", OCamlbuildDocPlugin.doc_clean "lib/")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          homepage = None;
          synopsis = "Ext JS 4.x bindings for the js_of_ocaml compiler";
          description = None;
          categories = [];
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build library generator";
                      flag_default =
                        [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build ocamldoc custom generator";
                      flag_default =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "all", true)
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["extUtils_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [(OASISExpr.EBool true, ["-D"; "OPTION_PASSED"])];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt =
                        [(OASISExpr.EBool true, ["-I"; "+ocamldoc"])];
                      bs_nativeopt =
                        [(OASISExpr.EBool true, ["-I"; "+ocamldoc"])];
                      },
                   {
                      lib_modules = ["Generator"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "libgen.ml"; });
               Doc
                 ({
                     cs_name = "oextjs";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      doc_title =
                        "API reference for Ext JS 4.x client library";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/helloext";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "oextjs";
                           FindlibPackage ("js_of_ocaml", None);
                           FindlibPackage ("pa_extjs", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/account_manager";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "oextjs";
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/grid/basic_array_grid";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "oextjs";
                      ...
                      },
                   {
                      lib_modules = [];
                      lib_pack = false;
                      lib_internal_modules = ["Array_grid"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/tabs/basic_tabs";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "oextjs";
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/window/window";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "oextjs";
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/window/layout";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "oextjs";
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/layout/border";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "oextjs";
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/layout/accordion";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "oextjs";
                      ...
                      },
                   {
                      lib_modules = [];
                      lib_pack = false;
                      lib_internal_modules = ["Accordion"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/misc/quicktips";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "oextjs";
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/misc/templates";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "oextjs";
                      ...
                      },
                   {
                      lib_modules = [];
                      lib_pack = false;
                      lib_internal_modules = ["Templates"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/combobox/basic_combobox";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "oextjs";
               ...
               Library
                 ({
                      ...
                      },
                   {
                      lib_modules = [];
                      lib_pack = false;
                      lib_internal_modules = ["Area"; "Example_data"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/toolbars/menu";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "oextjs";
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/dd/grid_to_grid";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "oextjs";
                      ...
                      },
                   {
                      lib_modules = [];
                      lib_pack = false;
                      lib_internal_modules = ["Dnd_grid_to_grid"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/forms/contact";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "oextjs";
                      ...
                      },
                   {
                      lib_modules = [];
                      lib_pack = false;
                      lib_internal_modules = ["Contact_form"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/drawing/sencha";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "oextjs";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\219\145K\151\018\153p\n*\022\167\170k\143\195\003";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
