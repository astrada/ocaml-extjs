...
or whether it is a descendant.</p> %}
    ...
    {- deep: [bool Js.t] (optional)
    {% <p>Pass <code>true</code> to test for the Component being a descendant at any level.</p> %}
     Defaults to: false
    }
    }
    ...
    {b Returns}:
    {ul {- [bool Js.t]
    {% <p><code>true</code> if the passed Component is contained at the specified level.</p> %}
    }
    }
    *)
...
If a layout has not been instantiated yet, that is done first</p> %}
  ...
  (** {% <p>Used by <a href="#!/api/Ext.ComponentQuery" rel="Ext.ComponentQuery" class="docClass">ComponentQuery</a>, <a href="#!/api/Ext.container.AbstractContainer-method-child" rel="Ext.container.AbstractContainer-method-child" class="docClass">child</a> and <a href="#!/api/Ext.container.AbstractContainer-method-down" rel="Ext.container.AbstractContainer-method-down" class="docClass">down</a> to retrieve all of the items
