...
of Ext must be referenced, this is the name that should be built into the code.</p> %}
  ...
  (** {% <p>The css class used to wrap Ext components when the <a href="#!/api/Ext-property-scopeResetCSS" rel="Ext-property-scopeResetCSS" class="docClass">scopeResetCSS</a> option
is used.</p> %}
    *)
  ...
  (** {% <p>True to scope the reset CSS to be just applied to Ext components. Note that this
...
load your javascript, in which case it will be handled for you).</p> %}
    *)
