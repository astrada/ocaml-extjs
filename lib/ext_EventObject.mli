...
\});
    ...
    {% <p><code>true</code> to test if the related target is within el instead of the target</p> %}
    }
    {- allowEl: [bool Js.t] (optional)
    {% <p><code>true</code> to also check if the passed element is the target or related target</p> %}
    }
    }
    *)
